...
import br.com.sistema.financas.model.repository.LancamentoRepository;
...
public class LancamentoServiceImp implements LancamentoService {
	...
	public List<Lancamento> buscar(Lancamento lancamentoFitro) {
		Example example = Example.of(lancamentoFitro,
